			...
			<div class="grid mdl-grid">
				<div
					...
					<form method="post" action="#" class="registro">
					 <?php registrar();?>					
					<span id="usuarioError"><li></li></span>
					<span id="emailError"><li></li></span>
					<span id="passwordError"><li></li></span>	
						<div class="mdl-color-text--grey-700 mdl-card__supporting-text ">
							...
							<div
								...
								<span class="input input--efecto"> <input
									...
									id="usuario" name="usuario"> <label class="input__label input__label--efecto"
									for="usuario"> <span
						...
						<path
							...
							<div
								...
								<span class="input input--efecto"> <input
									class="input__field input__field--efecto" type="email"
									id="email" name="email"> <label class="input__label input__label--efecto"
									for="email"> <span
						...
						<path
							...
							<div
								...
								<span class="input input--efecto"> <input
									...
									id="password" name="password"> <label class="input__label input__label--efecto"
									for="password"> <span
